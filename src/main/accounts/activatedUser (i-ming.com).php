...
http://www.i-ming.com/main/accounts/activatedUser.php?fn=activatedNew&verifyNewUser="
.$activate_code."&email=".$email."
			...
			if (isset($mail_send)) {
				...
				echo "<a href=\"http://www.i-ming.com/\">back</a>";
			}
			else {
?>				some problem to send e-mail <br>
				please use another E-mail.
				<br><a href="http://www.i-ming.com/">back</a>
<?php		}
