					...
					<td align="center" VALIGN="top" >
						<table border="0" width="100%" align="left" VALIGN="top" cellpadding="0" cellspacing="0">
							<tr>
								<td align="center">
<?php								if($url2 != ""){
										echo "<a href='".$rootpath."./main/text/?friend=".$rs[username]."'>"."<img width='100' height='100' src=\"".$rootpath."images/profile_picture/".$url2."\">";
									}
									else{
										echo "<a href='".$rootpath."./main/text/?friend=".$rs[username]."'>"."<img width='100' height='100' src=\"".$rootpath."images/profile3.png\">";
									}
?>								
								</td>
							</tr>
